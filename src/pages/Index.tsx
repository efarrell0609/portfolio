...
export default function Index() {
  ...
  return (
    <div className="min-h-screen w-full font-['Inter'] transition-colors duration-300 bg-white dark:bg-[#0f0f23]">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-white/90 dark:bg-[#0f0f23]/90 border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                {colorPickerOpen && (
                  <div className="absolute right-0 top-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-3 w-48">
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden overflow-hidden transition-all duration-300 bg-white dark:bg-[#0f0f23] border-t border-gray-200 dark:border-gray-800">
      ...
      <main className="pt-16">
        ...
        <section id="hero" className="min-h-screen flex items-center justify-center px-4 sm:px-6 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#0f0f23] dark:to-[#1a1a2e]">
        ...
        {/* About Section */}
        <section id="about" className="py-20 px-4 sm:px-6 bg-white dark:bg-[#0f0f23]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 relative overflow-hidden">
                  <div 
        ...
        {/* Skills Section */}
        <section id="skills" className="py-20 px-4 sm:px-6 bg-gray-50 dark:bg-[#1a1a2e]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                Technical Skills
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white dark:bg-[#16213e] rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <section id="cta" className="py-20 px-4 sm:px-6 bg-white dark:bg-[#0f0f23]">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-3xl p-12 sm:p-8 relative overflow-hidden">
              <div 
